...
| Video generations/edits/extensions | OmniRoute-like extended API | Done/Partial | `video_test.go`, `videoextra_test.go`, provider-scoped generation coverage; deeper variants still partial | P2 |
