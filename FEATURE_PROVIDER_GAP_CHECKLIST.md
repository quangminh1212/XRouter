...
| Provider-scoped compat routes `/api/v1/providers/{provider}/...` | 9router, CLIProxyAPI | Done/Partial | Registered real route alias and regression tests to avoid falling through to root handler; added `/web/fetch`, `/audio/voices`, `/audio/transcriptions`, and `/images/analyze` alias coverage | P1 |
