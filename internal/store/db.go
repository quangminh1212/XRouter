...
var providerCatalog = map[string]ProviderCatalogEntry{
	...
	"anthropic-m":          {Provider: "anthropic-m", AuthType: "apikey", APIType: "anthropic", BaseURL: "https://api.anthropic.com"},
	...
	"aws-polly":            {Provider: "aws-polly", AuthType: "apikey", APIType: "tts", BaseURL: "https://polly.{region}.amazonaws.com/v1/speech", FallbackModels: []string{"aws-polly/neural"}},
	...
	"brave":                {Provider: "brave", AuthType: "apikey", APIType: "search", BaseURL: "https://api.search.brave.com/res/v1"},
	...
	"searchapi":            {Provider: "searchapi", AuthType: "apikey", APIType: "search", BaseURL: "https://www.searchapi.io/api/v1/search"},
	"youcom":               {Provider: "youcom", AuthType: "apikey", APIType: "search", BaseURL: "https://api.ydc-index.io/search"},
	"youcom-search":        {Provider: "youcom-search", AuthType: "apikey", APIType: "search", BaseURL: "https://api.ydc-index.io/search"},
	"searxng":              {Provider: "searxng", AuthType: "apikey", APIType: "search"},
	"searxng-search":       {Provider: "searxng-search", AuthType: "apikey", APIType: "search"},
	...
	"google-pse":           {Provider: "google-pse", AuthType: "apikey", APIType: "search", BaseURL: "https://customsearch.googleapis.com/customsearch/v1"},
	...
	"copilot":              {Provider: "copilot", AuthType: "web_cookie", APIType: "openai", BaseURL: "https://copilot.microsoft.com", FallbackModels: []string{"copilot/gpt-4o-mini"}},
	"blackbox-web":         {Provider: "blackbox-web", AuthType: "web_cookie", APIType: "openai", BaseURL: "https://www.blackbox.ai", FallbackModels: []string{"blackbox-web/blackboxai-pro"}},
	...
	"alicode":              {Provider: "alicode", AuthType: "apikey", APIType: "openai", BaseURL: "https://dashscope.aliyuncs.com/compatible-mode/v1", FallbackModels: []string{"alicode/qwen-plus"}},
	"alicode-intl":         {Provider: "alicode-intl", AuthType: "apikey", APIType: "openai", BaseURL: "https://dashscope-intl.aliyuncs.com/compatible-mode/v1", FallbackModels: []string{"alicode-intl/qwen-plus"}},
	"xiaomi-mimo":          {Provider: "xiaomi-mimo", AuthType: "apikey", APIType: "openai", BaseURL: "https://api.xiaomimimo.com/v1", FallbackModels: []string{"xiaomi-mimo/mimo-v2.5-pro"}},
	"xiaomi-tokenplan":     {Provider: "xiaomi-tokenplan", AuthType: "apikey", APIType: "openai", BaseURL: "https://token-plan-sgp.xiaomimimo.com/v1", FallbackModels: []string{"xiaomi-tokenplan/mimo-v2.5-pro"}},
	"volcengine-ark":       {Provider: "volcengine-ark", AuthType: "apikey", APIType: "openai", BaseURL: "https://ark.cn-beijing.volces.com/api/v3", FallbackModels: []string{"volcengine-ark/deepseek-v3"}},
	"ollama":               {Provider: "ollama", AuthType: "apikey", APIType: "openai", BaseURL: "https://ollama.com/v1", FallbackModels: []string{"ollama/gpt-oss:120b"}},
	"ollama-local":         {Provider: "ollama-local", AuthType: "none", APIType: "openai", BaseURL: "http://localhost:11434/v1", FallbackModels: []string{"ollama-local/llama3.1"}},
	"blackbox":             {Provider: "blackbox", AuthType: "apikey", APIType: "openai", BaseURL: "https://api.blackbox.ai/v1", FallbackModels: []string{"blackbox/blackboxai-pro"}},
	"cursor":               {Provider: "cursor", AuthType: "oauth", APIType: "openai", BaseURL: "https://api2.cursor.sh", FallbackModels: []string{"cursor/claude-4.5-sonnet"}},
	"iflow":                {Provider: "iflow", AuthType: "oauth", APIType: "openai", BaseURL: "https://apis.iflow.cn/v1", FallbackModels: []string{"iflow/iflow-rome-30ba3b"}},
	"kilocode":             {Provider: "kilocode", AuthType: "oauth", APIType: "openai", BaseURL: "https://kilocode.ai/api/v1", FallbackModels: []string{"kilocode/claude-sonnet-4.5"}},
	"openclaw":             {Provider: "openclaw", AuthType: "oauth", APIType: "openai", BaseURL: "https://api.openclaw.ai/v1", FallbackModels: []string{"openclaw/openclaw"}},
	"amp":                  {Provider: "amp", AuthType: "oauth", APIType: "openai", BaseURL: "https://ampcode.com/api/v1", FallbackModels: []string{"amp/claude-sonnet-4.5"}},
	"continue":             {Provider: "continue", AuthType: "apikey", APIType: "openai", BaseURL: "https://api.continue.dev/v1", FallbackModels: []string{"continue/claude-sonnet-4.5"}},
	"commandcode":          {Provider: "commandcode", AuthType: "apikey", APIType: "openai", BaseURL: "https://api.commandcode.ai/v1", FallbackModels: []string{"commandcode/command-code"}},
	"command-code":         {Provider: "command-code", AuthType: "apikey", APIType: "openai", BaseURL: "https://api.commandcode.ai/v1", FallbackModels: []string{"command-code/command-code"}},
	"cliproxyapi":          {Provider: "cliproxyapi", AuthType: "oauth", APIType: "openai", BaseURL: "https://api.cliproxyapi.com/v1", FallbackModels: []string{"cliproxyapi/claude-sonnet-4.5"}},
	"kimi-coding":          {Provider: "kimi-coding", AuthType: "oauth", APIType: "openai", BaseURL: "https://kimi.moonshot.cn/api", FallbackModels: []string{"kimi-coding/kimi-k2"}},
	"oai-cc":               {Provider: "oai-cc", AuthType: "oauth", APIType: "openai", BaseURL: "https://api.openai.com/v1", FallbackModels: []string{"oai-cc/gpt-4o-mini"}},
	"oai-r":                {Provider: "oai-r", AuthType: "oauth", APIType: "openai", BaseURL: "https://api.openai.com/v1", FallbackModels: []string{"oai-r/gpt-4o-mini"}},
	"deepseek-tui":         {Provider: "deepseek-tui", AuthType: "oauth", APIType: "openai", BaseURL: "https://api.deepseek.com", FallbackModels: []string{"deepseek-tui/deepseek-chat"}},
	"droid":                {Provider: "droid", AuthType: "oauth", APIType: "openai", BaseURL: "https://factory.ai/api/v1", FallbackModels: []string{"droid/claude-sonnet-4.5"}},
	"jcode":                {Provider: "jcode", AuthType: "oauth", APIType: "openai", BaseURL: "https://jules.google.com/api/v1", FallbackModels: []string{"jcode/gemini-2.5-pro"}},
	...
	"stability-ai":         {Provider: "stability-ai", AuthType: "apikey", APIType: "image", BaseURL: "https://api.stability.ai/v2beta"},
	"recraft":              {Provider: "recraft", AuthType: "apikey", APIType: "image", BaseURL: "https://external.api.recraft.ai/v1"},
	"topaz":                {Provider: "topaz", AuthType: "apikey", APIType: "image", BaseURL: "https://api.topazlabs.com/v1"},
	"runwayml":             {Provider: "runwayml", AuthType: "apikey", APIType: "video", BaseURL: "https://api.dev.runwayml.com/v1"},
	"comfyui":              {Provider: "comfyui", AuthType: "none", APIType: "image", BaseURL: "http://localhost:8188"},
	"sdwebui":              {Provider: "sdwebui", AuthType: "none", APIType: "image", BaseURL: "http://localhost:7860"},
	"nanobanana":           {Provider: "nanobanana", AuthType: "apikey", APIType: "image", BaseURL: "https://api.nanobananaapi.ai/v1"},
	"google-tts":           {Provider: "google-tts", AuthType: "apikey", APIType: "tts", BaseURL: "https://texttospeech.googleapis.com/v1/text:synthesize"},
	"edge-tts":             {Provider: "edge-tts", AuthType: "none", APIType: "tts", BaseURL: "http://localhost:5050/v1/audio/speech"},
	"local-device":         {Provider: "local-device", AuthType: "none", APIType: "tts", BaseURL: "http://localhost:5051/v1/audio/speech"},
	"playht":               {Provider: "playht", AuthType: "apikey", APIType: "tts", BaseURL: "https://api.play.ht/api/v2/tts/stream"},
	"coqui":                {Provider: "coqui", AuthType: "none", APIType: "tts", BaseURL: "http://localhost:5002/api/tts"},
	"tortoise":             {Provider: "tortoise", AuthType: "none", APIType: "tts", BaseURL: "http://localhost:5003/v1/audio/speech"},
	"inworld":              {Provider: "inworld", AuthType: "apikey", APIType: "tts", BaseURL: "https://api.inworld.ai/tts/v1"},
	"agentrouter":          {Provider: "agentrouter", AuthType: "apikey", APIType: "openai"},
	"aimlapi":              {Provider: "aimlapi", AuthType: "apikey", APIType: "openai"},
	"apikey":               {Provider: "apikey", AuthType: "apikey", APIType: "openai"},
	"bazaarlink":           {Provider: "bazaarlink", AuthType: "apikey", APIType: "openai"},
	"cline":                {Provider: "cline", AuthType: "oauth", APIType: "openai"},
	"docker-model-runner":  {Provider: "docker-model-runner", AuthType: "none", APIType: "openai"},
	"empower":              {Provider: "empower", AuthType: "apikey", APIType: "openai"},
	"gigachat":             {Provider: "gigachat", AuthType: "apikey", APIType: "openai"},
	"gitlab":               {Provider: "gitlab", AuthType: "oauth", APIType: "openai"},
	"gitlab-duo":           {Provider: "gitlab-duo", AuthType: "oauth", APIType: "openai"},
	"heroku":               {Provider: "heroku", AuthType: "apikey", APIType: "openai"},
	"ironclaw":             {Provider: "ironclaw", AuthType: "oauth", APIType: "openai", BaseURL: "https://api.openclaw.ai/v1", FallbackModels: []string{"ironclaw/openclaw"}},
	"kie":                  {Provider: "kie", AuthType: "apikey", APIType: "openai"},
	"kilo-gateway":         {Provider: "kilo-gateway", AuthType: "oauth", APIType: "openai"},
	"lemonade":             {Provider: "lemonade", AuthType: "apikey", APIType: "openai"},
	"llamafile":            {Provider: "llamafile", AuthType: "none", APIType: "openai"},
	"llamagate":            {Provider: "llamagate", AuthType: "apikey", APIType: "openai"},
	"maritalk":             {Provider: "maritalk", AuthType: "apikey", APIType: "openai"},
	"modal":                {Provider: "modal", AuthType: "apikey", APIType: "openai"},
	"nanobot":              {Provider: "nanobot", AuthType: "apikey", APIType: "openai"},
	"nanogpt":              {Provider: "nanogpt", AuthType: "apikey", APIType: "openai"},
	"nlpcloud":             {Provider: "nlpcloud", AuthType: "apikey", APIType: "openai"},
	"nscale":               {Provider: "nscale", AuthType: "apikey", APIType: "openai"},
	"oauth":                {Provider: "oauth", AuthType: "oauth", APIType: "openai"},
	"oci":                  {Provider: "oci", AuthType: "apikey", APIType: "openai"},
	"opencode-dark":        {Provider: "opencode-dark", AuthType: "apikey", APIType: "openai", BaseURL: "https://api.opencode.ai/v1", FallbackModels: []string{"opencode-dark/opencode"}},
	"opencode-light":       {Provider: "opencode-light", AuthType: "apikey", APIType: "openai", BaseURL: "https://api.opencode.ai/v1", FallbackModels: []string{"opencode-light/opencode"}},
	"ovhcloud":             {Provider: "ovhcloud", AuthType: "apikey", APIType: "openai"},
	"piapi":                {Provider: "piapi", AuthType: "apikey", APIType: "openai"},
	"picoclaw":             {Provider: "picoclaw", AuthType: "oauth", APIType: "openai", BaseURL: "https://api.openclaw.ai/v1", FallbackModels: []string{"picoclaw/openclaw"}},
	"predibase":            {Provider: "predibase", AuthType: "apikey", APIType: "openai"},
	"puter":                {Provider: "puter", AuthType: "oauth", APIType: "openai"},
	"qianfan":              {Provider: "qianfan", AuthType: "apikey", APIType: "openai"},
	"sap":                  {Provider: "sap", AuthType: "apikey", APIType: "openai"},
	"scaleway":             {Provider: "scaleway", AuthType: "apikey", APIType: "openai"},
	"synthetic":            {Provider: "synthetic", AuthType: "apikey", APIType: "openai"},
	"wandb":                {Provider: "wandb", AuthType: "apikey", APIType: "openai"},
	"zeroclaw":             {Provider: "zeroclaw", AuthType: "oauth", APIType: "openai", BaseURL: "https://api.openclaw.ai/v1", FallbackModels: []string{"zeroclaw/openclaw"}},
}
